...
<div class="space-y-8">
    ...
    <div>
        <h3 class="font-heading text-xl font-semibold mb-6 text-brand-indigo dark:text-brand-cream stagger-item">Your Applications</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            @forelse($modules as $slug => $mod)
                <a href="{{ route('modules.'.$slug.'.dashboard') }}" class="bento-card stagger-item group block" data-hover-lift>
                    ...
                    <p class="text-sm font-sans text-brand-indigo/60 dark:text-brand-lavender mt-1 line-clamp-2">{{ $mod['description'] }}</p>
