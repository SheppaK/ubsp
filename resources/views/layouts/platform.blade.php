        ...
        <aside data-animate="sidebar" :class="sidebarOpen ? 'w-64' : 'w-20'" class="fixed inset-y-0 left-0 z-40 surface-sidebar transition-all duration-300 flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto p-3 space-y-1">
                ...
                @role('super-admin')
                    ...
                    <a href="{{ route('platform.deployment') }}" class="sidebar-link {{ request()->routeIs('platform.deployment*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                        ...
                        <span x-show="sidebarOpen">Deployment</span>
                    </a>
                    @endif
                @endrole
